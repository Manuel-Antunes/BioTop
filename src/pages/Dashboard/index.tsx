...
const Dashboard: React.FC = () => {
    return (
        <Container>
            ...
            ['B', 'Í', 'A', 'D', 'E', 'N', 'O', 'I', 'P', 'Ó', 'F', 'I', 'S', 'E', 'U', 'V', 'B', 'Ó', 'M', 'P', 'J', 'R', 'K',],]} answers={['TRATODIGESTIVO', 'PULMÕES', 'TÚNICAMUCOSA', 'DEGLUTIÇÃO', 'DUODENO', 'EOSINÓFILOS', 'ANTÍGENO', 'BASTONETES', 'ANTICORPO', 'CRÂNIO', 'MENINGES', 'CEREBELO', 'HORMÔNIOS', 'ADENOIPÓFISE', 'ANDRÓGENOS', 'TERMORRECEPTORES', 'CÓCLEA', 'FILTRAÇÃO', 'REABSORÇÃO', 'CAVIDADESNASAIS', 'TRAQUEIA', 'BRÔNQUIOS', 'VÊNULAS', 'HIPERTENSÃO', 'VALVAAÓRTICA']} onEnd={handleEndGame} finders={["É um tubo formado pela boca, faringe, esôfago, estômago, intestino delgado e intestino grosso.	",
